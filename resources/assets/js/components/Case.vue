                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                        <div class="openingSpinner">
                            ...
                            <div class="scrollBox" :style="spinStyle">
                                <div class="potentialWinning" :style="itemStyle" :class="item.iteminfo.type"
                        ...
                        <div class="openSection">
                            <button type="button" :disabled="rollDisabled" @click="openCase" class="btn btn-success">
                                Open Case
                            </button>
                        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            openCase() {
                axios.get(this.api + 'open/' + this.caseId, {}).then((res) => {
