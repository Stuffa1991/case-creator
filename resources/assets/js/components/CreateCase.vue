      ...
      <div class="col-lg-12">
        <div class="row itemName">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content">
              <input class="form-control input50" id="caseName" name="query" placeholder="Enter a name" v-model="caseName" @change="onCaseName">
          </div>
        </div>
        ...
        <div class="caseImages">
          <div class="row">
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12 container">
              <div class="row">
                <div id="caseImages" class="col-xs-12 col-sm-6 col-md-4 col-lg-3" v-for="(item,index) in caseimages">
                  <div class="caseCaption" :class="{ active: chosenImage == item.id }" @click="chooseImage(item.id)">
            ...
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
              <div class="row content">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <input class="search form-control" name="query" placeholder="Search" v-model="searchInput" @keyup.enter="onSearch">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                  <select id="inputType" class="form-control" v-model="orderByQuality" @change="onSortQuality">
        ...
        <div class="row item">
          ...
          <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12 container">
            <div class="row">
              <div class="col-lg-2 col-md-4 col-sm-4 col-xs-6" v-for="(item,index) in itemlist" @click="onAddItem(item,index)">
                <div class="thumbnail">
            ...
            <table class="table table-striped" v-if="itemcaselist.length > 0">
              <thead>
                ...
                <tr v-for="(item,index) in itemcaselist">
                  ...
                  <td>
                    <input class="form-control" @keyup="calcPrice(item.odds,index)" v-model="item.odds" placeholder="Insert" autofocus="" min="0.00001" max="100" step="1" type="number">
                  </td>
                  <td class="text-center" @click="onRemoveItem(item,index)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
        ...
        <div class="row errors">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div v-if="itemcaselist.length < 2" class="alert alert-danger" role="alert">Choose at least 2 items</div>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div v-if="(totalOdds < 100 || totalOdds > 100) && itemcaselist.length > 1" class="alert alert-danger" role="alert">Odds need to be combined 100</div>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div v-if="totalMinus == 1" class="alert alert-danger" role="alert">One odds is below minus</div>
            <div v-else-if="totalMinus > 1" class="alert alert-danger" role="alert">Several odds is below minus</div>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <div v-if="itemcaselist.length == maxItems" class="alert alert-danger" role="alert">Max item reached</div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-right">
            <button @click="onSubmit" :disabled="isSubmitDisabled" type="submit" class="btn btn-success">Submit</button>
          </div>
        </div>
      </div>
    </div>
    ...
    export default {
      ...
      methods: {
        ...
        onAddItem(item,index) {
          ...
          if(this.itemcaselist.filter((obj) => { return obj.id == item.id } ).length > 0) return;
          //If the case is full
